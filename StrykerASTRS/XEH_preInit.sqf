...
[
	...
	["Stryker TFAR Setter", "Preferences"],
...
[
	...
	["Stryker TFAR Setter", "Preferences"], _vlrDefault, 0, _vlrShowRun
] call cba_settings_fnc_init;

[
	QUOTE(GVAR(ShowLR)), "CHECKBOX",
	["LR Load/Save On", "Turn Off/On ability to set LR"],
	["Stryker TFAR Setter", "Preferences"], _lrDefault, 0, _lrShowRun
] call cba_settings_fnc_init;

[
	QUOTE(GVAR(ShowSR)), "CHECKBOX",
	["SR Load/Save On", "Turn Off/On ability to set SR"],
	["Stryker TFAR Setter", "Preferences"], _srDefault, 0, _srShowRun
] call cba_settings_fnc_init;
